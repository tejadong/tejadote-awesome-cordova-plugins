...
const DIST = resolve(ROOT, 'dist/@tejadong-awesome-cordova-plugins-tejadong-awesome-cordova-plugins');
...
const PLUGIN_PEER_DEPENDENCIES = {
  '@tejadong-awesome-cordova-plugins-tejadong-awesome-cordova-plugins/core': MIN_CORE_VERSION,
  rxjs: RXJS_VERSION,
};

function getPackageJsonContent(name: string, peerDependencies = {}, dependencies = {}) {
  return merge(PACKAGE_JSON_BASE, {
    name: '@tejadong-awesome-cordova-plugins-tejadong-awesome-cordova-plugins/' + name,
    dependencies,
    peerDependencies,
    version: VERSION,
  });
